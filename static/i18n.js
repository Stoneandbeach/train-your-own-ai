...
const TRANSLATIONS = {
  en: {
    ...
    drawClassesHint: (list) => `Draw one of: ${list}`,
    reset: "Reset",
  ...
  sv: {
    ...
    drawClassesHint: (list) => `Rita en av: ${list}`,
    reset: "Rensa",
    ...
    explainHintDrawings: "Klicka på en typ för att se vilket område som skulle hjälpa eller stjälpa den",
    aiStatusHeading: "AI-status",
    certaintyUnknown: (label) => `AI:n kan inte avgöra. Är det: ${label}?`,
